...
jobs:
    aspect-workflows:
        ...
        uses: my-org/workflows-action/.github/workflows/.aspect-workflows-reusable.yaml@5.10.0-alpha.4.dev.1.ged12ce9
```
...
jobs:
    delivery:
        ...
        steps:
            ...
            - name: Run Delivery
              uses: aspect-build/workflows-action@5.10.0-alpha.4.dev.1.ged12ce9
              with:
                  task: delivery
              env:
