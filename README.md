...
jobs:
    aspect-workflows:
        ...
        uses: my-org/workflows-action/.github/workflows/.aspect-workflows-reusable.yaml@5.10.0-rc1.dev.4.gb90d481
```
...
jobs:
    delivery:
        ...
        steps:
            ...
            - name: Run delivery
              uses: aspect-build/workflows-action@5.10.0-rc1.dev.4.gb90d481
              with:
                  task: delivery
