...
jobs:
    aspect-workflows:
        ...
        uses: my-org/workflows-action/.github/workflows/.aspect-workflows-reusable.yaml@5.11.0-alpha0.dev.89.g734f8ed
```
...
jobs:
    delivery:
        ...
        steps:
            ...
            - name: Run delivery
              uses: aspect-build/workflows-action@5.11.0-alpha0.dev.89.g734f8ed
              with:
                  task: delivery
