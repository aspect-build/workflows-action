...
jobs:
    aspect-workflows:
        ...
        uses: my-org/workflows-action/.github/workflows/.aspect-workflows-reusable.yaml@5.10.0-rc0.dev.19.g5e75389
```
...
jobs:
    delivery:
        ...
        steps:
            ...
            - name: Run delivery
              uses: aspect-build/workflows-action@5.10.0-rc0.dev.19.g5e75389
              with:
                  task: delivery
              env:
