...
jobs:
    aspect-workflows:
        ...
        uses: my-org/workflows-action/.github/workflows/.aspect-workflows-reusable.yaml@5.9.33-dev.1.g523789e
```
...
jobs:
    delivery:
        ...
        steps:
            ...
            - name: Run Delivery
              uses: aspect-build/workflows-action@5.9.33-dev.1.g523789e
              with:
                  task: delivery
              env:
