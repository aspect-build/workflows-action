...
jobs:
    aspect-workflows:
        ...
        uses: my-org/workflows-action/.github/workflows/.aspect-workflows-reusable.yaml@5.11.0-rc0.dev.16.g16e0517
```
...
jobs:
    delivery:
        ...
        steps:
            ...
            - name: Run delivery
              uses: aspect-build/workflows-action@5.11.0-rc0.dev.16.g16e0517
              with:
                  task: delivery
