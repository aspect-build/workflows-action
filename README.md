...
jobs:
    aspect-workflows:
        ...
        uses: my-org/workflows-action/.github/workflows/.aspect-workflows-reusable.yaml@5.10.0-alpha.9.dev.1.g6ee2563
```
...
jobs:
    delivery:
        ...
        steps:
            ...
            - name: Run Delivery
              uses: aspect-build/workflows-action@5.10.0-alpha.9.dev.1.g6ee2563
              with:
                  task: delivery
              env:
